...
namespace FluentFTP.Tests.Unit {
	public class ParserTests {
		...
		public void OpenVMS() {
			...
			var sample = new[] {
				"INT_FACUL_FUNCIONALIDADES_250509.TXT;1                        1951/2048        9-MAY-2025 14:23:37  [ID_PRODUCPU]            (RWED,RWED,RE,)",
			};

			var expected = new FtpListItem?[]{
				new FtpListItem("INT_FACUL_FUNCIONALIDADES_250509.TXT", 11, FtpObjectType.File, new DateTime(2012, 3, 21, 15, 17, 0, 0)),
			};
